...
button_add = Button(mywindow, text="+", padx=39, pady=20, command=button_add)
button_subtract = Button(mywindow, text="-", padx=41, pady=20, command=button_subtract)
button_multiply = Button(mywindow, text="*", padx=40, pady=20, command=button_multiply)
button_divide = Button(mywindow, text="/", padx=41, pady=20, command=button_divide)

button_equal = Button(mywindow, text="=", padx=91, pady=20, command=button_equal)
button_clear = Button(mywindow, text="Clear", padx=79, pady=20, command=button_clear)
